...
class Mob(pygame.sprite.Sprite):
	def __init__(self, screen, level_tile_rects, player, image, health, damage, speed):
	...
	def update(self):
		...
		self.rect, collisions = self.move(self.rect, self.mob_movement, self.level_tile_rects)
